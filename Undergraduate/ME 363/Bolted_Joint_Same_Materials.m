...
t1=1.5;  %thickness of sandwich material 1
t2=T-t1;    %thickness of sandwich material 2
...
Km=Eal*d*A*exp(B*d/T); %spring constant for sandwich
...
title('Safety Factor and Preload for Joint of Same Materials')
